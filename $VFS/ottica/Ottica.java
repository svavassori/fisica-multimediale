...
public class Ottica implements Exit
  { OtticaFrame frame;
    ...
    public Ottica(String args[])
      { ImageLoader ail=new ApplicationImageLoader();
        ...
        frame=new OtticaFrame(parm, this);
        frame.show();
        frame.toFront();
...
public class Ottica extends OtticaFrame implements Exit { // CinematFrame frame;
