 ...
 * for a pair of surfaces
 */
public class CoppiaDialog extends TrackedDialog
  { 
    Component target;
    HelpDisplayer help;
     ...
     * an action event having a CoppiaDialog object as the argument
     */
    public CoppiaDialog(Component target, double x, double y)
      { super(UserInterface.getDummyFrame(), 
              "Aggiungi coppia di lastre", true);
        ...
        Label lab=new Label("Aggiungi una coppia di lastre");
        lab.setFont(font_large);
        panel.add("", lab);

        dens=new NumericField(11, -1e-1, 1e-1);
        dens.setValue(1e-11);
        panel.add(new LabeledComponent(dens, "Densita' di carica [C/m^2]", 
        ...
        dist=new NumericField(8, 1e-1, 150);
        dist.setValue(5);
        panel.add("", new LabeledComponent(dist, "Distanza [m]", 
                                LabeledComponent.LEFT));

        ext=new NumericField(8, 1e-1, 150);
        ext.setValue(10);
        panel.add("", new LabeledComponent(ext, "Estensione [m]", 
                                LabeledComponent.LEFT));

        horiz=new Checkbox("Orizzontale");
        horiz.setState(true);
        panel.add("", horiz);
    ...
    public boolean action(Event evt, Object what)
      { if ("OK".equals(what))
          ...
          { help.displayHelp("help/elemag", "coppia");
          }
