...
public class MultiGraphicDialog extends TrackedDialog
  {     
    ...
    // edit here to estabilish the combined graphs to show
    int num_of_multiple_graphics=3;
    String multiple_graphs_names[]={"x, Vx, Ax rispetto al tempo", 
                                    "y, Vy, Ay rispetto al tempo",
                                    "En.cinetica, potenziale, totale risp. al tempo"};
    // each entry has the following format
    String multiple_graphs_choices[][]={{"Tempo","Posizione X","Velocità X","Accelerazione X"},
                                        {"Tempo","Posizione Y","Velocità Y","Accelerazione Y"},
                                        {"Tempo","Energia cinetica","Energia potenziale","Energia"}};
    // end area for multiple graphics
    ...
    synchronized public boolean action(Event evt, Object what)
      { if ("OK".equals(what))
          ...
          { help.displayHelp("help/dinam1", "graphsel");
          }
