...
public class Dinam2Frame extends TrackedFrame implements StatusDisplayer,CStatusDisplayer
  { ImageLoader il;
    HelpDisplayer help;
    Panel cardsPanel;
    CardLayout cards;
    ...
    public boolean action(Event evt, Object what)
      { 
        if ("Uscita...".equals(what))
            show("ExitPanel");
/*                  MessageBox.confirm(this, "Dinamica II", "Vuoi uscire dal programma?",
                             "*Exit*");*/
          ...
          { if (simulation==null)
              MessageBox.message(this,"Dinamica II - Esegui",
          ...
          { if (simulation==null || simulation.getStepCount()==0)
              MessageBox.message(this,"Dinamica II - Grafico",
          ...
          help.displayHelp("help/dinam2", "dinam2");
