...
/**
 * A dialog box to input conditions for reflection
 */
public class ReflectDialog extends TrackedDialog
  { 
    Component target;
    HelpDisplayer help;
     ...
     * an action event having a ReflectSettings object as the argument
     */
    public ReflectDialog(Component target, 
                         ReflectSettings initial)
    ...
    public boolean action(Event evt, Object what)
      { if ("OK".equals(what))
          { dispose();
            ReflectSettings settings=new ReflectSettings();
            int i;
          ...
          { help.displayHelp("help/onde", "reflect");
          }
