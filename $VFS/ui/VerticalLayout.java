...
/**
 * Vertical layout is used to layout buttons in a vertical toolbar.
 *
...
public class VerticalLayout implements LayoutManager {
    ...
    /**
     * The justified alignment variable.
     */
    ...
    /**
     * Constructs a new Vertical Layout with a centered alignment.
     */
    ...
    /**
     * Constructs a new Vertical Layout with the specified alignment and gap
     * values.
     * @param align the alignment value
     ...
     * the VerticalLayout object. 
     * @param target the specified component being laid out.
     * @see Container
     */
    public void layoutContainer(Container target) {
	    Insets insets = target.insets();
	    Dimension target_size=target.size();
	    int maxwidth = target_size.width - (insets.left + insets.right + hgap*2);
	    int nmembers = target.countComponents();
