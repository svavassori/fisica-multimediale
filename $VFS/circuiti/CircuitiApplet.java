...
public class CircuitiApplet extends Applet implements Exit
  { CircuitiFrame frame=null;
    ...
    public void init()
      { ail=new AppletImageLoader(this);
        ...
        String iconName=getParameter("icon", "icons/resist.gif");
