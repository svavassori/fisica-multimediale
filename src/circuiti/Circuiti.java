...
public class Circuiti implements Exit
  { CircuitiFrame frame;
    ...
    public Circuiti(String args[])
      { ImageLoader ail=new ApplicationImageLoader();
        ...
        frame=new CircuitiFrame(parm, this);
        frame.show();
        frame.toFront();
...
public class Circuiti extends CircuitiFrame implements Exit { // CinematFrame frame;
