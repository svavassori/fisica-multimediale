...
public class NAxesDrawer
  { CoordinateMapper map;
    ...
    public NAxesDrawer(CoordinateMapper map)
      { this.map=map;
      }
    ...
    public void drawAxes(Graphics g, Point pt, Color color)
      { drawAxes(g, pt, g.getClipRect(),color);
    ...
    public void drawAxes(Graphics g, Point pt, Rectangle clip, Color color)
      {
       if (clip==null)
          { Dimension d=map.getDimension();
            Insets   in=map.getInsets();
