 ...
 */
public class VectorInput extends Panel
  { VectorInputCanvas canvas;
     ...
     * and the y component
     */
    public VectorInput(double minx, double maxx, double miny, double maxy)
      { this.minx=minx;
        this.miny=miny;
        this.maxx=maxx;
        this.maxy=maxy;
        ...
        canvas=new VectorInputCanvas(this);
        ...
        pan.add("", lab);
        modulus=new NumericInput(iminmod, imaxmod, 0, scale_mod);
        pan.add("", modulus);
        ...
        pan.add("", lab);
        xComp=new NumericInput(iminx, imaxx, 0, scale_x);
        pan.add("", xComp);

        lab=new Label("Componente Y");
        pan.add("", lab);
        yComp=new NumericInput(iminy, imaxy, 0, scale_y);
        pan.add("", yComp);
...
class VectorInputCanvas extends Canvas
  { Color gridcol=Color.green;
    ...
    VectorInputCanvas(VectorInput parent)
      { vi=parent;
