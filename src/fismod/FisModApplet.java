...
public class FisModApplet extends Applet implements Exit
  { FisModFrame frame=null;
    ...
    public void init()
      { ail=new AppletImageLoader(this);
        ...
        String iconName=parm.getString("icon", "icons/atomo.gif");
