...
public class EleMag implements Exit
  { EleMagFrame frame;
    ...
    public EleMag(String args[])
      { ImageLoader ail=new ApplicationImageLoader();
        ...
        frame=new EleMagFrame(parm, this);
        frame.show();
        frame.toFront();
...
public class EleMag extends EleMagFrame implements Exit { // CinematFrame frame;
