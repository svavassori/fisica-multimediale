 ...
 */
public class CampoDialog extends TrackedDialog
  { 
    Component target;
    HelpDisplayer help;
    ...
    /**
     * Create a new magnetic field input dialog. If the user confirms
     * the changes, the target component will be notified with
     * an action event having a CampoDialog object as the argument
     */
    public CampoDialog(Component target)
      { super(UserInterface.getDummyFrame(), 
              "Campo magnetico", true);
        ...
        Label lab=new Label("Campo magnetico");
        lab.setFont(font_large);
        panel.add("", lab);

        intens=new NumericField(11, -1e-1, 1e-1);
        intens.setValue(1e-3);
        panel.add(new LabeledComponent(intens, "Intensità dell'induzione "+
                                               "magnetica [T]", 
    ...
    public boolean action(Event evt, Object what)
      { if ("OK".equals(what))
          ...
          { help.displayHelp("help/elemag", "campo");
          }
