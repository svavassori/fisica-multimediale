 ...
 * for a plane
 */
public class PianoDialog extends TrackedDialog
  { 
    Component target;
    HelpDisplayer help;
     ...
     * an action event having a PianoDialog object as the argument
     */
    public PianoDialog(Component target, double x, double y)
      { super(UserInterface.getDummyFrame(), 
        ...
        Label lab=new Label("Aggiungi un piano");
        ...
        ang=new NumericField(8, -90, 180);
        ang.setValue(0);
        panel.add(new LabeledComponent(ang, "Angolo [deg]", 
                                LabeledComponent.LEFT));
    ...
    public boolean action(Event evt, Object what)
      { if ("OK".equals(what))
          ...
          { help.displayHelp("help/elemag", "piano");
          }
    ...
    public double getAng()
      { return Math.PI*ang.getValue()/180;
      }
  }
